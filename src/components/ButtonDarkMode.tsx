...
export default function ButtonDarkMode() {
    ...
    return (
        <div className="fixed top-4 right-4 cursor-pointer hover:bg-slate-200 dark:hover:bg-slate-700 rounded-full p-1">  
            ...
            <svg onClick={handleChangeTheme} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`size-6 stroke-gray-300 ${theme=='dark'? "block" : "hidden"}`}>
